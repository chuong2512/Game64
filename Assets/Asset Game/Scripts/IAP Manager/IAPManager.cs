...
public class Key
{
    public const string PACK1 = "game64_ducklayegg_1";
    public const string PACK2 = "game64_ducklayegg_2";
    public const string PACK3 = "game64_ducklayegg_3";
    public const string PACK4 = "game64_ducklayegg_4";
    
    public const string PACK1_REGISTER = "register_ducklayegg_pack1";
    public const string PACK2_REGISTER = "register_ducklayegg_pack2";
    public const string PACK3_REGISTER = "register_ducklayegg_pack3";
    public const string PACK4_REGISTER = "register_ducklayegg_pack4";
    public const string PACK5_REGISTER = "register_ducklayegg_pack5";
}
